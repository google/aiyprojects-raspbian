...
def do_recognition(args, recorder, recognizer, player):
    ...
    mic_recognizer = SyncMicRecognizer(
        actor, recognizer, recorder, player, say, triggerer, led_fifo=args.led_fifo, trigger_sound=args.trigger_sound)
...
class SyncMicRecognizer(object):
    ...
    def __init__(self, actor, recognizer, recorder, player, say, triggerer, led_fifo, trigger_sound):
        self.actor = actor
        self.player = player
