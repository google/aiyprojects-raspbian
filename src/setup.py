...
setup(
    ...
    scripts=[
        ...
        "examples/gpiozero/bonnet_button.py",
        "examples/gpiozero/button_example.py",
        "examples/gpiozero/led_example.py",
        "examples/gpiozero/servo_example.py",
        "examples/gpiozero/simple_button_example.py",
        "examples/leds_example.py",
        "examples/vision/dish_classifier.py",
        "examples/vision/dish_detector.py",
        ...
        "examples/vision/mobilenet_based_classifier.py",
        "examples/vision/test_run_model_on_bonnet.py",
        "examples/vision/video_capture.py",
