...
def get_status_ui():
    ...
    """
    global _voicehat_status_ui
    if _voicehat_status_ui is None:
        _voicehat_status_ui = aiy._drivers._status_ui._StatusUi()
    return _voicehat_status_ui
